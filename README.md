...
- **Zoomen in volledig scherm**: in de presentatie-/volledig-schermmodus kun je nu in- en uitzoomen zonder de modus te verlaten — met zwevende +/−-knoppen onderin of met Ctrl+scrollen. Volledig scherm opent bovendien sneller bij grote documenten doordat de miniaturenstrip daar niet meer wordt getekend.
